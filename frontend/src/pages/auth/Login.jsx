...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const targetRoute = res.data.user.role === 'manager' ? '/dashboard' : '/my-reports';
...
const styles = {
  container: { display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh', background: 'transparent', padding: '1rem' },
